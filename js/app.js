(() => {
    ...
    function appendSlide(slides) {
        ...
        const appendElement = slideEl => {
            if (typeof slideEl === "string") {
                ...
                utils_setInnerHTML(tempDOM, slideEl);
                slidesEl.append(tempDOM.children[0]);
                utils_setInnerHTML(tempDOM, "");
    ...
    function initSliders() {
        ...
        if (document.querySelector(".hero__slider")) new Swiper(".hero__slider", {
            modules: [ Navigation, Manipulation, Autoplay ],
            observer: true,
            observeParents: true,
            speed: 1e4,
            loop: true,
        ...
        if (document.querySelector(".resource__slider")) new Swiper(".resource__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            loop: true,
            navigation: {
                prevEl: ".resource .control-slider__button-prev",
                nextEl: ".resource .control-slider__button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 3,
        ...
        if (document.querySelector(".news__slider")) new Swiper(".news__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".news .control-slider__button-prev",
                nextEl: ".news .control-slider__button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".partners__slider")) new Swiper(".partners__slider", {
            modules: [ Navigation, Manipulation, Autoplay ],
            observer: true,
            observeParents: true,
            speed: 1e4,
        ...
        if (document.querySelector(".latest-posts__slider")) new Swiper(".latest-posts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".latest-posts .control-slider__button-prev",
                nextEl: ".latest-posts .control-slider__button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".all-posts__slider")) new Swiper(".all-posts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".all-posts .control-slider__button-prev",
                nextEl: ".all-posts .control-slider__button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 3,
        ...
        if (document.querySelector(".video-posts__slider")) new Swiper(".video-posts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".video-posts .control-slider__button-prev",
                nextEl: ".video-posts .control-slider__button-next"
            },
            breakpoints: {
                768: {
                    slidesPerView: 2,
    ...
    if (searchToggle && searchForm) searchToggle.addEventListener("click", function() {
        searchToggle.classList.toggle("is-visible");
        searchForm.classList.toggle("is-visible");
        if (searchForm.classList.contains("is-visible")) searchForm.querySelector(".search__input").focus();
    });
    function updateHiddenAttribute() {
        const subMenuList = document.querySelectorAll(".mega-menu .sub-menu");
        const menuItems = document.querySelectorAll(".mega-menu .mega-menu__item.has-submenu");
    ...
    function toggleSubMenu(event) {
        ...
        if (window.innerWidth < 768 && subMenu) {
            document.querySelectorAll(".mega-menu .sub-open").forEach(openItem => {
                if (openItem !== menuItem) {
                    openItem.classList.remove("sub-open");
                    const openSubMenu = openItem.querySelector(".sub-menu");
                    if (openSubMenu) _slideUp(openSubMenu);
                }
            });
            menuItem.classList.toggle("sub-open");
            _slideToggle(subMenu);
        }
    }
    updateHiddenAttribute();
    window.addEventListener("resize", updateHiddenAttribute);
    ...
    if (videos.length) {
        ...
        videos.forEach(button => {
            ...
            button.addEventListener("click", e => {
                e.preventDefault();
                const container = button.closest("[data-video-container]") || button.parentElement;
                container.innerHTML = "";
                container.appendChild(createIframe(videoId));
            });
        });
    }
    const toggleBtn = document.getElementById("arch-nav-toggle");
    const filters = document.getElementById("arch-nav-filters");
    if (toggleBtn && filters) toggleBtn.addEventListener("click", function() {
        toggleBtn.classList.toggle("is-visible");
        filters.classList.toggle("is-visible");
        toggleBtn.setAttribute("aria-expanded", toggleBtn.classList.contains("is-visible"));
    });
    window["FLS"] = true;
    menuInit();
})();